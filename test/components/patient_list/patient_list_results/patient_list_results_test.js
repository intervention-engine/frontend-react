...
import PatientListResults, { mapStateToProps } from '../../../../src/components/PatientListResults/PatientListResults';
...
describe('Patients List Results', () => {
  ...
  beforeEach(() => {
    ...
    state = {
      patientListResults: patientsObject
    };
    component = renderComponent(PatientListResults, {}, state);
  });
  ...
  it('maps state to props', () => {
    ...
    expect(stateProps.patients).to.equal(patientsObject);
  });
